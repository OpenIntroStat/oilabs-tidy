...
14. Drop the variable with the highest p-value and re-fit the model.
...
15. Using backward-selection and p-value as the selection criterion, determine the best model.

...
In this lab, you will explore the data using the `dplyr` package and visualize it 
...
Your investigation will focus on the performance of one player: [Kobe Bryant](https://en.wikipedia.org/wiki/Kobe_Bryant) of 

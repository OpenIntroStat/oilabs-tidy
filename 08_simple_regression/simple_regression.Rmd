...
2.  What type of plot would you use to display the relationship between the personal freedom score, `pf_score`, and one of the other numerical variables?
...
For this model, 63.42% of the variability in runs is explained by at-bats.

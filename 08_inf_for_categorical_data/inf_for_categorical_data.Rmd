...
have texted while driving within the past 30 days? This variable is encoded as
`text_while_driving_30d`.

1.  What is the proportion of people who have texted while driving every day in 
the past 30 days and have not worn a helmet when biking in the last 12 months?
...
1.  Write out the conditions for inference to construct a 95% confidence
    interval for the proportion of non-helmet wearers in the past 12 months that
    have texted while driving for the past 30 days. Are you confident all 
    conditions are met?
...
proportion, it is necessary to include the `success` argument within `specify`,
which accounts for the proportion of non-helmet wearers in the last 12 months
than have consistently texted while driving the past 30 days. Here, the `stat`
argument within `calculate` is here "prop", signaling that you are trying
to do some sort of inference on a proportion.


1.  What is the margin of error for the estimate of the proportion of non-helmet 
wearers in the past 12 months that have texted while driving each day for the 

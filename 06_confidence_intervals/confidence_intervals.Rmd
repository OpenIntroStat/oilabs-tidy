...
a similar workflow. You can use these commands to generate a single confidence 
interval:
...
Note: `qnorm` is set to .975 for a two-sided 95 percent confidence interval since
...
1.  Find a singular two-sided confidence interval with a percentage of your choosing
(other than 95%) and interpret it.

...
In this lab, you will assume this 20% is a true population proportion and learn about how sample proportions can vary from sample to sample by taking smaller samples from the population. The data can be found in the `global_monitor` dataset in the **openintro** package, and responses to the question *"Do you believe that the work scientists do benefit people like you?"* is stored in the `scientist_work` in this data frame.

We can quickly visualize the distribution of these responses:
...
We can also obtain summary statistics:
...
1.  Change your sample size from 15 to 150, then compute the sampling 
    ...
    be the true proportion of those who think the work scientists do enchances their lives?

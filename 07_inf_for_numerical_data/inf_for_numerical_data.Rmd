...
5. How many of these `null` permutations have a difference of at least `obs_stat`?
...
6.  Construct and record a confidence interval for the difference between the 
...
7.  Calculate a 95% confidence interval for the average height in meters (`height`)
and interpret it in context.

8.  Calculate a new confidence interval for the same parameter at the 90% 
confidence level. Comment on the width of this interval versus 
the one obtained in the previous exercise.

9.  Conduct a hypothesis test evaluating whether the average height is different
for those who exercise at least three times a week and those who don't.

10.  Now, a non-inference task: Determine the amount of different options there 
are in the dataset for the `hours_tv_per_school_day` there are.

11. Come up with a research question evaluating the relationship between height 

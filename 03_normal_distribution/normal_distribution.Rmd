...
You'll see that for every observation there are 18 measurements, many of which are
nutritional facts. Note that the first column, `X1`, is a physical index for each
observation.

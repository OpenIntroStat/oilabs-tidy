...
To create your new lab report, start by opening a new R Markdown document... From Template... then select Lab Report from the `openintro` package. Make sure that all 

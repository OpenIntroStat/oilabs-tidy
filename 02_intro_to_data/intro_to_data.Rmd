...
We could also visualize the relationship between departure time and 
arrival delay, coloring by whether the departure was delayed or not using 
a scatterplot. 

```{r}
qplot(x=dep_time, y=arr_delay, color=dep_type, data=nycflights, geom="point")
```
